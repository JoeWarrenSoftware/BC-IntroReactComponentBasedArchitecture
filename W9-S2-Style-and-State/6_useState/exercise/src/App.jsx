...
function App() {
  ...
  const onAddContact = () => {
    console.log('onAddContact Invoke', newContact);
    if(validateContact())
    {
  ...
  function validateContact()
  {
    if (!newContact.name)
      {
        console.log('Failed Validation: Empty Contact Name');
        return false
      }
      else if (!newContact.position)
      {
        console.log('Failed Validation: Empty Position');
        return false
      }
      else if (!newContact.company)
      {
        console.log('Failed Validation: Empty Company');
        return false
      }
      else if (!newContact.email)
      {
        console.log('Failed Validation: Empty Email');
        return false
      }
      else if (!newContact.phone)
      {
        console.log('Failed Validation: Empty Phone');
        return false
      }
      else if (!newContact.website)
      {
        console.log('Failed Validation: Empty Website');
        return false
      }
      return true
  }
